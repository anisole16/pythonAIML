...
############################################################
# Step 9: Analyze Assignments Completed VS Final Result
############################################################

print("\n" + Border)
print("Step 9: Analyze Assignments Completed VS Final Result")
print(Border)
...
if assignment_result[1] > assignment_result[0]:
    print(
        "Passed students completed more assignments on average "
        "than failed students."
    )
else:
    print(
        "Passed students did not complete more assignments "
        "than failed students."
    )
...
plt.savefig("step9_assignments_vs_result.png")
...
############################################################
# Step 10: Analyze Sleep Hours VS Final Result
############################################################

print("\n" + Border)
print("Step 10: Analyze Sleep Hours VS Final Result")
print(Border)

print("Average Sleep Hours by Result:")
...
if sleep_result[1] > sleep_result[0]:
    print(
        "Passed students have higher average sleep hours "
        "than failed students."
    )
else:
    print(
        "Passed students do not have higher average sleep hours "
        "than failed students."
    )


# Boxplot of Sleep Hours by Final Result
...
plt.savefig("step10_sleep_hours_vs_result.png")
